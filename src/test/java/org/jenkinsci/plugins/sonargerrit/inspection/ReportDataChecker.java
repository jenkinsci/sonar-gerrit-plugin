...
public class ReportDataChecker {
    ...
    private static void checkReport1File(Report rep) {
        ...
        Assert.assertEquals(
                "com.maxifier.guice:guice-jpa:src/main/java/com/magenta/guice/jpa/DBInterceptor.java",
                i2.getComponent());
        ...
        Assert.assertEquals(
                "com.maxifier.guice:guice-bootstrap:src/main/java/com/magenta/guice/bootstrap/plugins/PluginsManager.java",
                i4.getComponent());
        ...
        Assert.assertEquals("com.maxifier.guice:guice-jpa", c1.getKey());
        Assert.assertEquals("guice-jpa", c1.getPath());

        Component c2 = rep.getComponents().get(1);
        Assert.assertEquals("com.maxifier.guice:guice-events", c2.getKey());
        Assert.assertEquals("guice-events", c2.getPath());

        Component c3 = rep.getComponents().get(2);
        Assert.assertEquals("com.maxifier.guice:guice-bootstrap", c2.getKey());
        Assert.assertEquals("guice-bootstrap", c2.getPath());

        Component c4 = rep.getComponents().get(3);
        Assert.assertEquals("com.maxifier.guice:guice-bootstrap:src/main/java/com/magenta/guice/bootstrap/plugins/ChildModule.java", c2.getKey());
        Assert.assertEquals("src/main/java/com/magenta/guice/bootstrap/plugins/ChildModule.java", c2.getPath());
        Assert.assertEquals("com.maxifier.guice:guice-bootstrap", c2.getModuleKey());
        Assert.assertEquals("SAME", c2.getStatus());

        Component c5 = rep.getComponents().get(4);
        Assert.assertEquals("com.maxifier.guice:guice-jpa:src/main/java/com/magenta/guice/jpa/DBInterceptor.java.java", c2.getKey());
        Assert.assertEquals("src/main/java/com/magenta/guice/jpa/DBInterceptor.java", c2.getPath());
        Assert.assertEquals("com.maxifier.guice:guice-jpa", c2.getModuleKey());
        Assert.assertEquals("SAME", c2.getStatus());
    ...
    private static void checkSCRep1(Report rep){
        ...
        Component c1 = rep.getComponents().get(0);
        Assert.assertEquals("com.maxifier.guice:guice-bootstrap", c1.getKey());
        Assert.assertEquals("guice-bootstrap", c1.getPath());
    ...
    private static  void checkSCRep2(Report rep){
        ...
        Component c2 = rep.getComponents().get(1);
        Assert.assertEquals("com.maxifier.guice:guice-jpa:src/main/java/com/magenta/guice/jpa/DBInterceptor.java", c2.getKey());
        Assert.assertEquals("src/main/java/com/magenta/guice/jpa/DBInterceptor.java", c2.getPath());
        Assert.assertEquals("com.maxifier.guice:guice-jpa", c2.getModuleKey());
        Assert.assertEquals("SAME", c2.getStatus());
    }
